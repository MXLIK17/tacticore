...
function ResultsPage({ mode, seasonResult, worldCup, onBuildAgain }) {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7848/ingest/aac2d5c6-87a7-429e-9f99-f1df9e70d234',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'c1a092'},body:JSON.stringify({sessionId:'c1a092',runId:'pre-fix',hypothesisId:'E',location:'ResultsPage.jsx:premier',message:'results page render',data:{displayed:{wins:seasonResult.wins,draws:seasonResult.draws,losses:seasonResult.losses,played:seasonResult.played,points:seasonResult.points},mode},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
